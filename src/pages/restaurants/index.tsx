...
function RestaurantListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<RestaurantInterface[]>(
    ...
    () =>
      getRestaurants({
        relations: ['user', 'manager.count', 'reservation.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>manager</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.manager}</Td>
                    )}
                    {hasAccess('reservation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
